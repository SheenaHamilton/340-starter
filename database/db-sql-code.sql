...
-- Create appointment table for test drives
CREATE TABLE IF NOT EXISTS public.appointment (
	apt_id					INTEGER				NOT NULL 	GENERATED BY DEFAULT AS IDENTITY,
	apt_date				DATE			 	NOT NULL,
	apt_time				TIME 				NOT NULL,
	inv_id					INTEGER				NOT NULL,
	account_id				INTEGER		 		NOT NULL,
	
	CONSTRAINT appointment_pkey PRIMARY KEY (apt_id)
);

-- Create relationship between 'inventory' and 'appointment' tables
